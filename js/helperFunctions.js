...
function getAllObjectsOnPage () {
  const objectTable = document.querySelector("#content > div.SailContainerWeb---sailcontents.appian-context-browser-chrome.appian-context-os-windows > div > div > div.HeaderBodyLayout---pane_frame > div > div > div > div.SplitPaneLayout---pane.SplitPaneLayout---secondary_pane > div > div > div.MultiColumnLayout---column_layout.MultiColumnLayout---stack_when_phone.appian-context-last-in-list.MultiColumnLayout---no_spacing.MultiColumnLayout---fixed > div > div > div.FieldLayout---input_below > div > div > table > tbody")
